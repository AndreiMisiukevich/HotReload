...
namespace Xamarin.Forms.HotReload.Extension.WinVS.Controls
{
    /// <summary>
    ...
    public partial class IpTextBox
    {
        ...
        private static readonly List<Key> NumPadDigitKeys = new List<Key>
        {
            Key.NumPad0,
            Key.NumPad1,
            Key.NumPad2,
        ...
        {
            if (DigitKeys.Contains(e.Key) || NumPadDigitKeys.Contains(e.Key))
            {
